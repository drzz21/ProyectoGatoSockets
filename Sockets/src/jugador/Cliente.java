...
public class Cliente implements Runnable{
    ...
    public Cliente(Main frame){
        try {
            ...
            CatA = ImageIO.read(getClass().getResource("CatA.png"));
            CatB = ImageIO.read(getClass().getResource("CatB.png"));
    ...
    public void run() {
        try{
            ...
            while(true){
                ...
                */
                if(xo == 1)
                    botones[f][c].setIcon(new ImageIcon(CatA));
                else
                    botones[f][c].setIcon(new ImageIcon(CatB));
                /*
